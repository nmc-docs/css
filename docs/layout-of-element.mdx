...
- `margin-top`, `margin-bottom`, `margin-left`, `margin-right` có thể nhận giá trị âm.
...
function MyComponent(props) {
  return (
    <>
      ...
      />
      <div className="margin-test-container">
        <div className="margin-test-child1"></div>
        <div className="margin-test-child2"></div>
        <div className="margin-test-child3"></div>
      </div>
    </>
  );
}
